...
@Entity
@Table(name = "uorder", schema = "uma", catalog = "")
@EntityListeners(AuditingEntityListener.class)
public class UOrderEntity implements Serializable {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        UOrderEntity that = (UOrderEntity) o;
        return id == that.id &&
                prodId == that.prodId &&
