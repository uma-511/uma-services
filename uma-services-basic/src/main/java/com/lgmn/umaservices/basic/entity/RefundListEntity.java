...
@Entity
@Table(name = "refund_list", schema = "uma", catalog = "")
@DynamicUpdate
@DynamicInsert
@SelectBeforeUpdate
public class RefundListEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        RefundListEntity that = (RefundListEntity) o;
        return id == that.id &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, refundId, clientId, clientName, number, name, specs, width, color, requirement, scanQuantity, residualQuantity, unitPrice, totalPrice,quantity,packageQuantity);
    }
}